...
#read data
train_x = np.load('train_belending_x_new.npy')
train_y = np.load('train_blending_y_new.npy')

test_x = np.load('test_blending_x_new_train.npy')
...
# test_x = np.load('test_blending_x_new_orig_train.npy')
...
evaluate_method.get_ROC(test_y_1D,y_probability_first,save_path='roc_blending_test.txt')
